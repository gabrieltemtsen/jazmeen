import { Bg } from '@/constants/ImageExport';
import React from 'react';

const Card = ({ title, subtitle, rating,
  //  backgroundColors, 
  className = "", image }) => {
  ...
  return (
    <div
      className={'card flex flex-col justify-center p-5 rounded-[10%] border border-gray-400/40 relative text-white overflow-hidden h-fit w-fit z-10  hover:-translate-y-10 transition-all duration-300 ' + className}
      style={{
    ...
    >
       {/* <div
      className={'card flex bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 flex-col justify-center p-5 rounded-[10%] border border-gray-400 relative text-white overflow-hidden h-fit w-fit z-10  hover:-translate-y-10 transition-all duration-300 ' + className}
      style={{
        // background: `linear-gradient(to bottom, ${top}, ${bottom})`,
        background: `linear-gradient(to bottom, #9333ea, )`,
      }}
    ></div> */}
