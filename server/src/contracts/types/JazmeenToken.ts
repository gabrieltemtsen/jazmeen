...
export interface JazmeenTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  getEvent(
    nameOrSignatureOrTopic: "Approval" | "MetadataUpdated" | "Transfer"
  ): EventFragment;
...
export namespace MetadataUpdatedEvent {
  export type InputTuple = [newImageUrl: string];
  export type OutputTuple = [newImageUrl: string];
  export interface OutputObject {
    newImageUrl: string;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface JazmeenToken extends BaseContract {
  connect(runner?: ContractRunner | null): JazmeenToken;
  waitForDeployment(): Promise<this>;

  interface: JazmeenTokenInterface;
